...
export default function Home() {
  ...
  return (
    <main className={styles.main}>
      ...
      <p className={styles.texto}>Descubra se você está na rota certa para o sucesso do seu negócio Você vai descobrir por que o seu negócio ainda não conquistou os resultados que você deseja, mesmo com todo o seu empenho. Uma das maiores razões de você se sentir perdido é porquê sabe o que precisa ser feito, mas não consegue colocar em prática. Sente que não tem tempo para focar na direção correta e achar as oportunidades certas para alavancar o seu negócio. Sem julgamento, é hora de dar o próximo passo neste teste! </p>
